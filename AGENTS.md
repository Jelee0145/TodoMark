...
Electron 30+ · electron-vite · React 18 · Vite · TypeScript · Tailwind v4 · Zustand · React Router v6 · better-sqlite3 · active-win · @uiw/react-md-editor · @milkdown/crepe · electron-builder。
...
/notes               三栏：分组 / 笔记列表 / MD 编辑器（@uiw/react-md-editor）
/todos               内联分组 + 子待办（FLIP 动画、收展、提醒、关联笔记）
/settings            分类规则 CRUD、idle 阈值、清空
/sticky-note/:noteId 独立便签窗口（alwaysOnTop，无顶栏）
/documents           独立 Markdown 文档工作台
```
